...
import { ItemEvaluateResult } from '@shared/module/poe/service';
import { colorSets } from '@swimlane/ngx-charts';
import * as shape from 'd3-shape';

@Component({
  selector: 'app-evaluate-area-chart',
  templateUrl: './evaluate-area-chart.component.html',
  styleUrls: ['./evaluate-area-chart.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class EvaluateAreaChartComponent {
  private _result: ItemEvaluateResult;
  ...
  @Input()
  public set result(result: ItemEvaluateResult) {
    this._result = result;
    this.update();
  }
